...
import java.util.Scanner;
	...
	public class Analysing_Disposable_Income {
		...
		public static void main(String[] args) {	
			...
			double monthlyGrossIncome, monthlyIncomeAfterTax, monthlyCostOfAccommodation, monthlyCostOfTravel, monthlyCostOfFood, monthlyDisposableIncome, monthlyDisposableIncomePercentageOfGrossIncome;
